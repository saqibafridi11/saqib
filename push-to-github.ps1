# push-to-github.ps1 - Clean working version
...
$projectPath = "C:\xampp\htdocs\my"  # <-- Your current folder
...
$commitMessage = "Update website with secure CMS - $date"
...
Write-Host ""
Write-Host "Website will be live in 1-2 minutes" -ForegroundColor Cyan
